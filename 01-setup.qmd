...
#| label: install
#| eval: false 
#| filename: "Packages required for this chapter"
...
::: {.cell-output}
```
✔ Creating /Users/debruine/rproj/demopkg/.
✔ Setting active project to "/Users/debruine/rproj/demopkg".
✔ Creating R/.
✔ Writing DESCRIPTION.
Package: demopkg
...
✔ Opening /Users/debruine/rproj/demopkg/ in new RStudio session.
...
#| label: license
#| eval: false
#| filename: "Run one in the console"
