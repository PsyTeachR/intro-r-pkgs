...
That particular example was `r glossary("significant", "non-significant")`. Let's add a version that does show a significant difference and make sure the text changes appropriately.
...
Now let's change the `r glossary("default value", "default values")` for the DV and labels.
